...
def send_order_email(data):
    ...
    recipients = os.environ.get('ORDER_EMAILS',
        ...
        'rahim.boumaza@gmail.com,abderahim@hayhaybakery.com,johnraybondoc083095@gmail.com,'
...
def post_to_sheet(data):
    """Push the order to the Google Sheet via an Apps Script webhook (non-fatal)."""
